...
<style>
    ...
    .top-category-tabs::-webkit-scrollbar { height: 4px; }
    .top-category-tabs::-webkit-scrollbar-thumb { background: #ddd; border-radius: 5px !important; }
    ...
    @media (max-width: 768px) {
        ...
        .top-product-card { padding: 5px; }
        .card-price-main { font-size: 15px; }
    }
    ...
    .card-image-wrapper {
        ...
        text-align: center;
        margin-bottom: 15px;
        overflow: hidden; /* Để không tràn ảnh khi zoom */
        border-radius: 8px;
    }
    ...
    .top-product-card:hover .card-name {
        color: #d71921; /* Đổi màu tên khi hover card */
    }
    ...
    .top-product-card:hover .card-price-main {
        transform: scale(1.05); /* Giá to nhẹ khi hover */
        transform-origin: left;
    }

    .sale-percent {
        background: linear-gradient(135deg, #d71921 0%, #f39c12 100%);
        border-radius: 4px 10px 4px 10px; /* Kiểu cắt góc xéo */
    }

    /* Mobile mượt hơn */
    @media (max-width: 768px) {
        .top-selling-container { border-radius: 0; border: none; }
        .top-product-card:hover { transform: translateY(-3px); }
    }
</style>
@endpush